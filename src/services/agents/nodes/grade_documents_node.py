...
from .utils import extract_sources_from_tool_messages, extract_tool_artefacts, get_latest_context, get_latest_query
...
async def ainvoke_grade_documents_step(
    ...
    if not context:
        ...
        return {
            ...
            "relevant_tool_artefacts": extract_tool_artefacts(state["messages"]),
        }
