...
- Cite specific papers when making claims using arXiv IDs from the retrieved context
- If the retrieved context includes section labels, prefer citing them along with the arXiv ID
...
- Do NOT include a references section or cite books, papers, or authors that are not explicitly present in the retrieved context
- If only one retrieved paper is clearly relevant, say that the answer is primarily based on that paper
